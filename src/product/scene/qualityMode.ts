...
/** Settings-only patch — does not touch engine internals. */
...
export function inferQualityMode(
  state: Pick<AppState, 'characterQuality' | 'physicsMode' | 'rtxModeEnabled' | 'visualFx'>
): QualityMode {
  if (
